...
public class EditCustomer extends javax.swing.JFrame {
    ...
    public EditCustomer(Customer customer) {
        ...
        initComponents();
        //populates the text boxes with information from the database
    ...
    private void initComponents() {
        ...
        txtHouseNumber.setText("jTextField1");
        ...
        //once clicked will update the database with any information thats been changed
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        
        if(!txtPassword.getText().isEmpty() && !txtFirstName.getText().isEmpty() && !txtLastName.getText().isEmpty() && !txtHouseNumber.getText().isEmpty()
            ...
            Customer customer = new Customer(loggedInCustomer.getUsername(), password, firstName, lastName, houseNumber, street, town, postcode);
            
            DBManager db = new DBManager();
            
            
            db.updateCustomer(customer);
            lblMessage.setText("Your details have been updated successfuly");
            loggedInCustomer = customer;
        } else {
            lblMessage.setText("Please fill out all details");
        
    
        }
    }//GEN-LAST:event_btnSubmitActionPerformed
    //sends the user to the customer home page when clicked
